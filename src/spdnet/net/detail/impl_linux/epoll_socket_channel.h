        ...
        namespace detail {
            ...
            public:
                ...
                void flush_buffer() {
                    ...
                    while (!session_->pending_packet_list_.empty()) {
                        size_t cnt = 0;
            ...
            private:
                ...
                void do_recv() {
                    ...
                    while (true) {
                        ...
                        int recv_len = static_cast<int>(::readv(session_->sock_fd(), vec, 2));
                        ...
                        if (SPDNET_PREDICT_TRUE(nullptr != session_->data_callback_)) {
                            ...
                            if (SPDNET_PREDICT_TRUE(len == recv_buffer.get_length())) {
                                ...
                                if (stack_len > 0) {
                                    len = session_->data_callback_(stack_buffer, stack_len);
